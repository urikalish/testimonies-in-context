var dataProvider = {
  ...
  getRealMarkersData: function getRealMarkersData() {
    return [
      ...
      {type: 'allied', from: 19450117, to: 19450117, lat: 52.2461, lng: 20.9958, url: '', text: 'Soviets capture Warsaw'},
      ...
      {type: 'allied', from: 19450119, to: 19450119, lat: 51.759445, lng: 19.457216, url: '', text: 'Liberation of the Lodz Ghetto'},
      ...
      {type: 'allied', from: 19450127, to: 19450127, lat: 50.0358, lng: 19.1783, url: 'http://static.guim.co.uk/sys-images/Guardian/Pix/pictures/2015/1/20/1421770241684/Red-Army-doctor-at-Auschw-012.jpg', text: 'Liberation of Auschwitz'},
      ...
      {type: 'allied', from: 19440816, to: 19440816, lat: 52.631069, lng: 22.053058, url: '', text: 'Soviets capture Treblinka'},
      {type: 'allied', from: 19440606, to: 19440606, lat: 49.3689, lng: 0.8686, url: 'http://dailycaller.com/wp-content/uploads/2012/06/dday2-e1338990214516.jpg', text: '6 June 1944 "D-Day" - <a href="https://en.wikipedia.org/wiki/Normandy_landings" target="_blank"/>Allied invasion of Normandy</a><br/>The largest seaborne invasion in history, the operation began the liberation of German-occupied northwestern Europe from Nazi control, and contributed to the Allied victory on the Western Front.'},
      {type: 'allied', from: 19440825, to: 19440825, lat: 48.8567, lng: 2.3508, url: 'https://upload.wikimedia.org/wikipedia/commons/d/d7/General_Charles_de_Gaulle_and_his_entourage_set_off_from_the_Arc_de_Triumphe_down_the_Champs_Elysees.jpg', text: '25 August 1945 - <a href="https://en.wikipedia.org/wiki/Liberation_of_Paris" target="_blank"/>Liberation of Paris</a>'},
      {type: 'allied', from: 19441216, to: 19441216, lat: 50.25, lng: 5.666667, url: 'https://upload.wikimedia.org/wikipedia/commons/6/61/GERMAN_TROOPS_ADVANCING_PAST_ABANDONED_AMERICAN_EQUIPMENT.jpg', text: '<a href="https://en.wikipedia.org/wiki/Battle_of_the_Bulge" target="_blank"/>The Battle of the Bulge</a>'},
      {type: 'allied', from: 19450322, to: 19450322, lat: 49.8547, lng: 8.35974, url: 'https://www.ibiblio.org/hyperwar/USA/USA-E-Last/img/USA-E-Last-p288.jpg', text: '22 March 1945 - <a href="https://en.wikipedia.org/wiki/Operation_Plunder" target="_blank"/>Patton crosses the Rhine River</a>'},
      {type: 'allied', from: 19450401, to: 19450401, lat: 52.5167, lng: 13.3833, url: 'http://i.dailymail.co.uk/i/pix/2008/05_01/reichstag_468x329.jpg', text: '<a href="https://en.wikipedia.org/wiki/Battle_of_Berlin" target="_blank"/>Battle of Berlin</a>'},
      {type: 'allied', from: 19450430, to: 19450430, lat: 48.1333, lng: 11.5667, url: '', text: 'Fall of Munich'},
  ...
  getFakeMarkersData: function getFakeMarkersData(from, to) {
    return [
      {type: 'picture', from: from, to: to, lat: Math.floor((Math.random() * 7) + 46), lng: Math.floor((Math.random() * 25) + 5), url: '', text: ''},
      {type: 'document', from: from, to: to, lat: Math.floor((Math.random() * 7) + 46), lng: Math.floor((Math.random() * 25) + 5), url: '', text: ''},
      {type: 'video', from: from, to: to, lat: Math.floor((Math.random() * 7) + 46), lng: Math.floor((Math.random() * 25) + 5), url: '', text: ''},
      {type: 'audio', from: from, to: to, lat: Math.floor((Math.random() * 7) + 46), lng: Math.floor((Math.random() * 25) + 5), url: '', text: ''},
      {type: 'righteous', from: from, to: to, lat: Math.floor((Math.random() * 7) + 46), lng: Math.floor((Math.random() * 25) + 5), url: '', text: ''}
    ];
  },
  getRealEventsData: function getRealEventsData() {
    return [
